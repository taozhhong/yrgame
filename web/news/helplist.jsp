...
<div id="main">
  ...
  <div class="main_right">
    ...
    <div class="main_box">
      <div class="location"><span><p>常见问题</p></span>
        <div class="en">
       <!--当前位置-->
      ...
      <div class="news_list">
        <div class="class_list">
          <span class="curr"><a href="/news/help/cate/1">常见问题</a></span>
            <span><a href="/news/cust/id/2/40">隐私安全</a></span>
          <span><a href="/news/cust/id/3/41">关于我们</a></span>
          <span><a href="/news/cust/id/4/42">联系我们</a></span>
        </div>
         ...
         <ul>
             ...
             %>
             <li><a href='/news/article/id/<%=pro.getCateid()%>/<%=pro.getArticleid()%>'><%=pro.getArticletitle()%></a></li>
             <%
                     }
                     NewsIt.remove();
                 }
