        ...
        <table class="table-edit" width="98%" align="center">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="hidden" name="membermethod" value="setpwd"/>
                    <input type="password" name="newpass" id="newpass"
                           class="easyui-validatebox"
                           maxlength="20"
                           data-options="required:true,validType:'length[6,20]',
                              invalidMessage:'请输入6-20位登录密码',
                              missingMessage:'请输入6-20位登录密码'"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="password" name="repass" id="repass"
                           ...
                           maxlength="20"
                           data-options="required:true,validType:'length[6,20]',
                              invalidMessage:'请输入6-20位确认密码',
                              missingMessage:'请输入6-20位确认密码'"/>
                </td>
            </tr>
        </table>
    </form>
