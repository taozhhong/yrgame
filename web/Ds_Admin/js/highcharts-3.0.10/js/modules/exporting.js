...
(function (f) {
    ...
    s.exporting = {type: "image/png", url: "http://192.168.0.104/Action/ExportReport.do", buttons: {contextButton: {menuClassName: "highcharts-contextmenu",
    ...
    f.post = function (b, a, d) {
        var c, b = l("form", k({method: "post",
            action: b, enctype: "multipart/form-data",encoding:"multipart/form-data"}, d), {display: "none"}, j.body);
