    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#areaid').combotree({
                //获取数据URL
                required: true,
                invalidMessage: '请选择商户所在地',
                missingMessage: '请选择商户所在地',
                valueField: 'id',
                textField: 'text',
                lines:true,
                animate: false,//动画效果
                url: '/Action/AreaWriter.do?areamark=s_treelist',
                onBeforeSelect: function (node) {
                    //$('#areaid').combotree("tree").tree("options").url = "/Action/AreaWriter.do?areamark=treelist&id=" + node.id+"&random="+Math.random();
//                    var tree = $(this).tree;
                ...
                $('#form').form('submit', {
                    ...
                    success: function (msg) {
                        ...
                        if (jsondata.err == "")//表示没有出错
                        {
                            ...
                            $(window.parent.$("#StoreList").datagrid('reload'));
                        }
                        else {
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
        ...
        <table class="table-edit" width="98%" align="center">
            ...
            <tr>
                <td>商户名称:</td>
                <td>
                    <input type="hidden" value="add" name="usermethod"/>
            ...
            <tr>
                ...
                <td>
                    <select id="status" class="easyui-combobox" name="status" style="width:150px;*width: 155px;"
                        ...
                        %>
                        <option value="<%=i%>"><%=Field_Str.User_State[i]%>
                        </option>
                        <%
                            }
                        %>
