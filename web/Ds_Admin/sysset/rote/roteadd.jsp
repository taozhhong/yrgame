    ...
    <form id="form" method="post">
        <table class="table-edit" width="98%" align="center">
            ...
            <tr>
                ...
                <td>
                    <input type="hidden" id="rotemethod" name="rotemethod" value="add"/>
                    <input type="hidden" value="<%=bid%>" name="bid"/>
                    <input type="hidden" value="<%=sid%>" name="sid"/>
                    <input type="text" name="rotename" id="rotename" class="easyui-validatebox"
                ...
                <td>
                    <ul id="tt1" class="easyui-tree" data-options="animate:true">
                        ...
                        <li data-options="state:'closed'">
                            <span><input type="checkbox" name="b_roteauth" value="<%=i%>" id="b_roteauth_<%=i%>"
                                         onclick="CheckBMenuBox('<%=i%>');"/><span
                            ...
                            <ul>
                                ...
                                %>
                                <li data-options="state:'closed'">
                                    <span><input type="checkbox" name="s_roteauth_<%=i%>" value="<%=ii%>"
                                                 id="s_roteauth_<%=i%>_<%=ii%>"
                                    ...
                                    <ul>
                                        ...
                                        %>
                                        <li>
                                            <span><input type="checkbox" name="roteopt_<%=i%>_<%=ii%>" value="<%=iii%>"
                                                         id="roteopt_<%=i%>_<%=ii%>" disabled="disabled"/><span
            ...
            <tr>
                ...
                <td><textarea style="width:85%;height: 50px;" name="nodes" id="nodes"
                                          ...
                                          onpropertychange="Aboutcount(this,'NodesMsg',500);"></textarea><br><br>
