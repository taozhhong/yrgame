...
<head>
    ...
    <script type="text/javascript">
        $(function() {
            $('#form').form('load', '/Action/SysAnnWriter.do?sysmark=mlist&sysannid=<%=sysannid%>&random=' + Math.random());
        ...
        <table class="table-edit" width="98%" align="center">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="hidden" name="sysmethod" value="edit"/>
                    <input type="hidden" name="sysannid"/>
